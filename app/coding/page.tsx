    ...
    <div className="min-h-screen bg-black text-white font-poppins">
      ...
      <nav className="flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 py-4 pt-8 sm:pt-4">
        ...
        <div className="flex gap-2 sm:gap-4 space-x-4 sm:space-x-8 font-bold text-sm sm:text-md px-4 sm:px-10">
          ...
          <Link href="/coding" className="text-lofi-purple transition-colors border-b-2 border-lofi-purple">Coding</Link>
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-block">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-lofi-purple">MY WORKS</h1>
          </div>
          <p className="text-gray-300 mt-4 max-w-2xl mx-auto">
            A collection of my coding projects, tools, and games showcasing my journey in software development.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-lofi-purple/20 to-lofi-blue/20 backdrop-blur-sm p-8 rounded-xl border border-lofi-purple/30 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-lofi-purple mb-4">Interested in Collaborating?</h2>
