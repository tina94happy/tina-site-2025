    ...
    <div className="min-h-screen bg-black text-white font-poppins">
      ...
      <nav className="flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 py-4 pt-8 sm:pt-4">
        ...
        <div className="flex gap-2 sm:gap-4 space-x-4 sm:space-x-8 font-bold text-sm sm:text-md px-4 sm:px-10">
          ...
          <Link href="/learning" className="text-lofi-purple transition-colors border-b-2 border-lofi-purple">Learning</Link>
        </div>
      </nav>
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-block">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-lofi-purple">MY ARTICLES</h1>
          </div>
          <p className="text-gray-300 mt-4 max-w-2xl mx-auto">
            Sharing knowledge and insights through technical articles on cybersecurity, networking, and cloud technologies.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-lofi-purple/20 to-lofi-blue/20 backdrop-blur-sm p-8 rounded-xl border border-lofi-purple/30 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-lofi-purple mb-4">Stay Updated</h2>
            <p className="text-gray-300 mb-6">
              Follow my learning journey and get notified about new articles on cybersecurity, networking, and cloud technologies.
            </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-lofi-pink/20 to-lofi-accent/20 backdrop-blur-sm p-6 rounded-xl border border-lofi-pink/30 text-center">
            ...
            <div className="text-gray-300">Learning Journey</div>
          </div>
        </div>
      </div>
    </div>
